...
# import data
SAE_path = (
    "/Users/Ty/Desktop/FDP_brakes_proj_local/FDPBrakes/Datasets/Test_Data_Filter.csv"
)
...
def FIG3():
    ...
    with sns.axes_style("white"):
        ...
        heat = sns.heatmap(corr, mask=mask, vmax=0.3, square=True)
